...
public class TraceRecorder {
    ...
    public static synchronized void before(String className,String methodName,String desc) {
        String[] clazzNameArray = className.split("/");
            String result = clazzNameArray[clazzNameArray.length-1]+"."+methodName+"---"+desc;
            before(result);
    }
    public static synchronized void after(String className,String methodName,String desc) {
        String[] clazzNameArray = className.split("/");
        String result = clazzNameArray[clazzNameArray.length-1]+"."+methodName+"---"+desc;
        after(result);
    }
